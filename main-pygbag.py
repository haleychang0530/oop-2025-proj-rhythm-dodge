...
while True:
    if game_state == "start":
        ...
        if not level:
            ...
            sys.exit()
        if level == 1:
            pygame.mixer.music.load("assets/music/level1.ogg")
            with open("levels/level1.json", "r") as f:
                events = json.load(f)
        elif level == 2:
            pygame.mixer.music.load("assets/music/level2.ogg")
        ...
        while running:
            ...
            if not player.alive:
                if inclock < 1:
                    ...
                    sound = pygame.mixer.Sound("assets/sound_effect/mus_sfx_a_lithit.ogg")
