...
def draw_text():
    # 畫出上排 RH_THM
    screen.blit(font.render("RH", True, WHITE), (50, 100))
    screen.blit(font.render("TH", True, WHITE), (320, 100))
    screen.blit(font.render("M", True, WHITE), (480, 100))
    
    # 畫出下排 D DGE（中間那顆齒輪的位置留空）
    screen.blit(font.render("D", True, WHITE), (80, 220))
    screen.blit(font.render("DGE", True, WHITE), (300, 220))

def draw_triangles():
    # Y 的紅色倒三角
    pygame.draw.polygon(screen, RED, [
        (260, 100 + triangle_offset),
        (300, 100 + triangle_offset),
        (280, 140 + triangle_offset)
    ])
    
    # M 的藍色直立三角
    pygame.draw.polygon(screen, BLUE, [
        (525, 100 + triangle_offset),
        (545, 140 + triangle_offset),
        (505, 140 + triangle_offset)
    ])
